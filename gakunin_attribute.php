...
<?php
    ...
    function check_exportAssertion($attr, $attr_value = '', $ea_attr_value = ''){
        ...
        // Check of Scope for ePPN & ePSA & gakuninScopedPersonalUniqueCode
        if ($attr === 'eppn' || $attr === 'affiliation' || $attr === 'gakuninScopedPersonalUniqueCode') {
        ...
        // Check of vocabulary for ePA & ePSA
        if ($attr === 'unscoped-affiliation' || $attr === 'affiliation') {
    ...
    $envary = array(
        ...
        "gakuninScopedPersonalUniqueCode" => array("<a href='https://meatwiki.nii.ac.jp/confluence/display/GakuNinShibInstall/gakuninScopedPersonalUniqueCode'>gakuninScopedPersonalUniqueCode</a>" , "normal_value"),
        "isMemberOf"           => array("<a href='https://meatwiki.nii.ac.jp/confluence/display/GakuNinShibInstall/isMemberOf'>isMemberOf</a>"                                                   , "normal_value"),
    );
    ...
    foreach ($envary as $attr => $key) {
        ...
        print '        <tr>';
        print '<td name="name_' . $attr . '" class="' . $chart_class["key"] . '" scope="col" nowrap>' . $attr_description . '</td>';
        print '<td name="value_' . $attr . '" class="' . $chart_class["val"] . '">' . $val;
